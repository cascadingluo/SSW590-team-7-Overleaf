...
% \PassOptionsToPackage{pygmentize=/usr/local/texlive/2025/texmfdist/tex/latex/minted/minted.sty/usr/bin/pygmentize}{minted}
...
\usepackage{graphicx}
\usepackage{epstopdf}          % enable EPS->PDF on the fly
\epstopdfsetup{outdir=./}      % write converted PDFs next to your tex
