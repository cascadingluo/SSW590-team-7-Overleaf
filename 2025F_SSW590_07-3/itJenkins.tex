...
% \section{Part 1: Jenkins Setup in Docker} To set up Jenkins within a Docker container, the following \texttt{docker-compose.yml} file was created:
...
% The \texttt{requirements.txt} file includes the following dependency:
