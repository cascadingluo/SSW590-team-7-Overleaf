...
We ran into the issue of when we visted the site it failed to connect, to fix that, we went to digital ocean and added a new TCP protocol for 8080, and after that we were able to see the site alternating when refreshed:
...
http {
        server {
                listen 80;
                server_name web1.annanyajain.me;
                location / {
        ...
        server {
                listen 80;
                server_name web2.annanyajain.me;
                location / {
...
and then compose and check for usage in the droplet with commands and receiving these back: (see figure 13.2)
\begin{figure}
      \centering
...
showing that the vhost and load balancer is working.

We then set up the DNS with these information:
A	web1	174.138.68.199	3600 and
A	web2	174.138.68.199	3600

Then it started working on chrome.
\begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{png/web11.png}
      \caption{verifying that the link work on web1.annanyajain.me}
      \label{fig:placeholder}
\end{figure}
\begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{png/web22.png}
      \caption{verifying that the link work on web2.annanyajain.me}
      \label{fig:placeholder}
\end{figure}