...
11/12/2025 & Luo:
\begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=12pt]
\item Updated the DNS links (\autoref{Chapter::Load Balancer and Virtual Machine})
\end{itemize} 
\\ \hline
...
10/23/2025 & Annanya:
\begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=12pt]
\item Documented configuration setup of Prometheus with Grafana (\autoref{sec:Prometheus-Grafana Monitoring Setup})
\end{itemize} 
\\ \hline
...
10/05/2025 & Annanya:
\begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=12pt]
\item Updated and documented the Overleaf Chapter (\autoref{sec:overleaf-containerized})
\end{itemize} 
\\ \hline
